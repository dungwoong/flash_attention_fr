...
// NOTE: I checked out the cluster code in sm90_pipeline.hpp, and it does seem like
// when cluster_size == 1 they set is_signalling_thread to true for all threads
